                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="pname">
                                <div class="image">
                                    <img src="{{ asset('uploads/productimage/' . $orderitem->product->image) }}" alt="Product Image" class="image">
                                </div>
                                <div class="name">
        ...
        <div class="wg-box mt-5">
           ...
           <form action="{{route('admin.order.status.update')}}" method="post">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <button type="submit" class="btn btn-primary tf-button vw208"> Update Status</button>
                </div>
            </div>
           </form>
        </div>
