                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap14">
                                ...
                                <div>
                                    ...
                                    <h4>{{$dashboarddates[0]->TotalAmount}}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap14">
                                ...
                                <div>
                                    ...
                                    <h4>{{$dashboarddates[0]->TotalDeliveredAmount}}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap14">
                                ...
                                <div>
                                    ...
                                    <h4>{{$dashboarddates[0]->TotalCanceled}}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap14">
                                ...
                                <div>
                                    ...
                                    <h4>{{$dashboarddates[0]->TotalCanceledAmount}}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="mb-2">
                            <div class="block-legend">
                                ...
                                <div class="text-tiny">Pendding</div>
                            </div>
                        </div>
                        <div class="flex items-center gap10">
