...
<style>
    .table-transaction>tbody>tr:nth-of-type(odd) {
        --bs-table-accent-bg: #7f8175 !important;
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="pname">
                                        <div class="image">
                                            <img src="{{asset('uploads/productimage')}}/{{$orderitem->product->image}}" alt="" class="image">
                                        </div>
                                        <div class="name">
